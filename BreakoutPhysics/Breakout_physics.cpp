...
public:
	...
	virtual void UserStartUp(Mona::World& world) noexcept {
		...
		auto& config = Mona::Config::GetInstance();
		auto& audioClipManager = Mona::AudioClipManager::GetInstance();
		m_ballBounceSound = audioClipManager.LoadAudioClip(config.getPathOfApplicationAsset("AudioFiles/ballBounce.wav"));
...
public:
	...
	virtual void UserStartUp(Mona::World & world) noexcept override {
		...
		auto& config = Mona::Config::GetInstance();
		auto& audioClipManager = Mona::AudioClipManager::GetInstance();
		m_blockBreakingSound = audioClipManager.LoadAudioClip(config.getPathOfApplicationAsset("AudioFiles/boxBreaking.wav"));
		auto& meshManager = Mona::MeshManager::GetInstance();
